...
export default function SOSScreen() {
  ...
  async function requestLocation() {
    ...
    try {
      ...
      if (status !== 'granted') {
        setLocationError('Location permission denied. Location will not be included in alerts.');
      ...
      [
        { text: 'Cancel', style: 'cancel' },
        {
          ...
          onPress: async () => {
            ...
            if (error) {
              Alert.alert('Error', 'Failed to send SOS. Try calling security directly.');
              setSending(false);
              return;
            }
    ...
    <View style={styles.container}>
      ...
      <ScrollView contentContainerStyle={styles.scroll}>
        ...
        <Text style={styles.subtitle}>
          Press the SOS button to alert campus security and your trusted contacts
        </Text>
        ...
        <TouchableOpacity
          style={[
            ...
            !locationLoading && !locationError && location ? styles.locationCardOk : null,
          ]}
          onPress={() => {
            if (location?.coords) {
          ...
          <View style={styles.locationInfo}>
            ...
            {locationLoading ? (
              ...
              <Text style={[styles.locationSub, styles.locationSubError]}>{locationError}</Text>
            ) : location ? (
              <>
        ...
        <View style={styles.sosSection}>
          ...
          <Text style={styles.sosHint}>Press and confirm to send emergency alert</Text>
        </View>
        ...
        {/* Direct Call */}
        <TouchableOpacity style={styles.callCard} onPress={callSecurity} activeOpacity={0.8}>
          <View style={styles.callIcon}>
            <Text style={styles.callEmoji}>📞</Text>
          </View>
          <View style={styles.callInfo}>
            <Text style={styles.callTitle}>Call Campus Security</Text>
            <Text style={styles.callSub}>Direct phone call to security office</Text>
          </View>
        </TouchableOpacity>
        ...
        <View style={styles.card}>
          <View style={styles.cardHeaderRow}>
            ...
            <TouchableOpacity onPress={() => setShowAddContact(!showAddContact)}>
              <Text style={styles.addBtn}>{showAddContact ? 'Cancel' : '+ Add'}</Text>
            </TouchableOpacity>
          </View>
          ...
          {contacts.length === 0 ? (
            <Text style={styles.noContacts}>
              No trusted contacts added yet. Add friends who can help in emergencies.
            </Text>
          ) : (
...
const styles = StyleSheet.create({
  ...
  subtitle: { fontSize: 14, fontWeight: FW.caption, color: TX.secondary, marginBottom: 24 },
  ...
  sosText: { fontSize: 18, fontWeight: FW.hero, color: '#fff', letterSpacing: 2 },
  sosHint: { fontSize: 12, fontWeight: FW.caption, color: TX.label, marginTop: 12 },
  ...
  cardTitle: { fontSize: 18, fontWeight: FW.cardTitle, color: TX.primary, marginBottom: 8 },
  cardDesc: { fontSize: 13, fontWeight: FW.caption, color: TX.label, marginBottom: 16 },
  addBtn: { fontSize: 14, fontWeight: FW.body, color: '#818CF8', marginBottom: 8 },
  ...
  callSub: { fontSize: 12, fontWeight: FW.caption, color: TX.label, marginTop: 2 },
  ...
  noContacts: { fontSize: 13, fontWeight: FW.caption, color: TX.label, lineHeight: 20 },
  ...
  contactPhone: { fontSize: 12, fontWeight: FW.caption, color: TX.label, marginTop: 2 },
  ...
  tipText: { flex: 1, fontSize: 13, fontWeight: FW.caption, color: TX.secondary, lineHeight: 20 },
  ...
  locationInfo: { flex: 1 },
  locationTitle: { fontSize: 14, fontWeight: FW.cardTitle, color: TX.primary, marginBottom: 2 },
